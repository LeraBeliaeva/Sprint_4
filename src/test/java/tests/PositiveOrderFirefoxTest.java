...
public class PositiveOrderFirefoxTest {
    ...
    @Parameterized.Parameters(name = "Firefox | Заказ: {0} {1}, кнопка: {9}, цвет: {7}")
    ...
    public void testPositiveOrderScenario() {
        ...
        assertTrue("Заказ не был оформлен в Firefox!", orderPage.isOrderCreated());
    }
